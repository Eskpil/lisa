...
gcc -m32 -c src/kernel.c -o build/kernel.o -std=c11 -ffreestanding -O2 -Wall -Wextra

#linking the kernel with kernel.o and boot.o files
ld -m elf_i386 -T src/linker.ld build/kernel.o build/boot.o -o build/lisa.bin -nostdlib
